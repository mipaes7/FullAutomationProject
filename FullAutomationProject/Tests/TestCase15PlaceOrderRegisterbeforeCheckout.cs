...
{
    internal class TestCase15PlaceOrderRegisterbeforeCheckoutTest : Base
    {

        [TestCase(TestName = "TestCase15PlaceOrderRegisterbeforeCheckout")]

        public void TestCase15PlaceOrderRegisterbeforeCheckout()
        {
