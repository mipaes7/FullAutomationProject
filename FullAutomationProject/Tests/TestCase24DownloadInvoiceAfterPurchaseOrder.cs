...
{
    internal class TestCase24DownloadInvoiceAfterPurchaseOrderTest : Base
    {
        [TestCase (TestName = "TestCase24DownloadInvoiceAfterPurchaseOrder")]

        public void TestCase24DownloadInvoiceAfterPurchaseOrder()
        {
            ...
            UserDetails user = userDetailsBuilder
                .WithName("janesmith33")
                .WithEmail("jane.smith33@example.com")
